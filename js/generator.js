function generate() {
	...
	let clothes_style = ["нижнее белье", "кэжуал", "преппи", "вечернее платье в пол", "спортивный костюм", "свит-лолита", "готик-лолита", "первобытный", "пижама", "бальное платье", "слитный купальник", "бикини", "романтичный", "минимализм", "свадебное платье", "гранж", "классический", "коктейльное платье", "e-girl", "soft-girl", "cottagecore", "академический", "бельевой", "школьная форма", "ретро", "бохо", "милитари"];
	...
	if (bg_clothes == 20) bg_clothes = 20;
	else if (bg_clothes == 14) bg_clothes = 14;
	else bg_clothes = 0;
	...
	if (hairstyle == 12) {
		document.getElementById("hair").style.zIndex = 100;
		document.getElementById("bodyfeat").style.zIndex = 110;
	}
	else document.getElementById("hair").style.zIndex = 50;	

	document.getElementById("bg_clothes").src="generator/bg_clothes/" + bg_clothes + ".png";
